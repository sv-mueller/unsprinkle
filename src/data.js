...
const createSrcSet = (src, ext) => {
	const photoName = src.replace(/\.[^/.]+$/, "");
	return `${photoName}.${ext} 1x, ${photoName}@2x.${ext} 2x, ${photoName}@3x.${ext} 3x`;
};

export const createAvifSrcSet = (src) => createSrcSet(src, "avif");
export const createJpgSrcSet = (src) => createSrcSet(src, "jpg");
